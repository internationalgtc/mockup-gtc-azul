...
export const equipo: TeamMember[] = [
  ...
  // LIDERES
  { id: 3, nombre: 'Antonio Cabello', foto: fotoAntonio, rol: 'Head of Finance', rolEn: 'Head of Finance', email: 'acabello@globaltalent-connections.com', linkedin: 'https://www.linkedin.com/in/antonio-jesus-cabello-barea/', nivel: 'lider' },
  ...
  // OPERATIVO
  { id: 8, nombre: 'Sebastián Acevedo', foto: fotoSebastian, rol: 'Quality & Ops Lead', rolEn: 'Quality & Ops Lead', email: 'sacevedo@globaltalent-connections.com', linkedin: '', nivel: 'lider' },
  ...
  { id: 16, nombre: 'Suany Artica', foto: fotoSuany, rol: 'Quality Analyst', rolEn: 'Quality Analyst', email: 'sartica@globaltalent-connections.com', linkedin: '', nivel: 'operativo' },
