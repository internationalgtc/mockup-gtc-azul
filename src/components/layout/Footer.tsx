...
// Íconos de marca inline (esta versión de lucide no los trae).
...
// Redes activas de GTC — enlazadas desde la web para conectar la autoridad
// externa con el sitio, algo que la auditoría marcó faltante.
const SOCIALS = [
  { label: 'LinkedIn', href: 'https://linkedin.com/company/global-talent-connections-limited', Icon: LinkedinIcon },
  { label: 'Instagram', href: 'https://www.instagram.com/globaltalentconnections/', Icon: InstagramIcon },
]
          ...
          <div className="flex items-center gap-3">
            {SOCIALS.map(({ label, href, Icon }) => (
              <a
                ...
                aria-label={label}
                className="w-9 h-9 rounded-full border border-white/15 flex items-center justify-center text-white/70 hover:text-white hover:border-blue-light hover:bg-blue-prime/10 transition-colors"
              >
